...
convgru_encoder_params = [
    ...
    [
        CGRU_cell(shape=(32,32), input_channels=16, filter_size=5, num_features=64),
        CGRU_cell(shape=(16,16), input_channels=64, filter_size=5, num_features=96),
        CGRU_cell(shape=(8,8), input_channels=96, filter_size=5, num_features=96)
    ]
]
...
convgru_decoder_params = [
    ...
    [
        ...
        CGRU_cell(shape=(32,32), input_channels=96, filter_size=5, num_features=64),
    ]
]